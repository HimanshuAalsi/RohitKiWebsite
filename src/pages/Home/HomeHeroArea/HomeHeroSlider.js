                           ...
                           <div className="row">
                              <div className="col-xl-9 col-lg-9 col-md-10 col-sm-10">
                                 <div className="slider__content">
                                    <h1>Step Into the Grid of <br /> Creative Possibilities</h1>
                                    <span>At GraphicsGrid, we bring creativity and strategy together to deliver<br /> cutting-edge designs for brands ready to grow.</span>
