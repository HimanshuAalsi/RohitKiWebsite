                  ...
                  <div className="container">
                     <div className="row align-items-center">
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6">
                           <div className="logo">
                              <NavLink to="/">
                                 <img src="assets/img/graphic grid logo/graphic-grid-logo.png" alt="logo" style={{maxHeight: '60px'}}/>
                              </NavLink>
                           </div>
                           <div className="logo-gradient">
                              <NavLink to="/">
                                 <img src="assets/img/graphic grid logo/graphic-grid-logo-light.png" alt="logo" style={{maxHeight: '60px'}}/>
                              </NavLink>
                           </div>
                        </div>
